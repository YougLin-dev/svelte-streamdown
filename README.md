...
| `subscript`                | `boolean`                                                                        | `true`           | Enable `~text~` subscript syntax in the `Streamdown` component; set to `false` to keep literal tildes                                              |
| `superscript`              | `boolean`                                                                        | `true`           | Enable `^text^` superscript syntax in the `Streamdown` component; set to `false` to keep literal carets                                            |
